...
def show_game_over():
    ...
    game_screen.blit(game_over_text, (width // 2 - game_over_text.get_width() // 2, height // 2 - 50))
    game_screen.blit(final_score_text, (width // 2 - final_score_text.get_width() // 2, height // 2 + 10))
    pygame.display.update()
